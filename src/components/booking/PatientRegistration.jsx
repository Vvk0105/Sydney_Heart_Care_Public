...
const PatientRegistration = ({ medicareData, onComplete, onBack, isEditing = false, patientId = null }) => {
    const [formData, setFormData] = useState({
        title: medicareData?.title || 'Mr',
        full_name: medicareData?.full_name || '',
        phone: medicareData?.phone ? formatAUPhone(medicareData.phone) : '',
        email: medicareData?.email || '',
        address: medicareData?.address || '',
        suburb: medicareData?.suburb || '',
        state: medicareData?.state || 'NSW',
        postcode: medicareData?.postcode || '',
        occupation: medicareData?.occupation || '',
        next_of_kin_name: medicareData?.next_of_kin_name || '',
        next_of_kin_relationship: medicareData?.next_of_kin_relationship || '',
        next_of_kin_phone: medicareData?.next_of_kin_phone ? formatAUPhone(medicareData.next_of_kin_phone) : '',
        gp_name: medicareData?.gp_name || '',
        gp_phone: medicareData?.gp_phone ? formatAUPhone(medicareData.gp_phone) : '',
        gp_suburb: medicareData?.gp_suburb || '',
        gp_state: medicareData?.gp_state || 'NSW',
        gp_postcode: medicareData?.gp_postcode || '',
        other_specialist_name: medicareData?.other_specialist_name || '',
        other_specialist_phone: medicareData?.other_specialist_phone ? formatAUPhone(medicareData.other_specialist_phone) : '',
        other_specialist_address: medicareData?.other_specialist_address || '',
        health_fund_name: medicareData?.health_fund || '',
        health_fund_membership: medicareData?.health_fund_membership || '',
        pension_number: medicareData?.pension_number || '',
        veterans_affairs_number: medicareData?.veterans_affairs_number || '',
        veterans_affairs_card_type: medicareData?.veterans_affairs_card_type || '',
        workers_comp_claim: medicareData?.workers_comp_claim || false,
        workers_comp_details: medicareData?.workers_comp_details || '',
        legal_process: medicareData?.legal_process_involved || false,
        consent_given: medicareData?.consent_given || false,
        cancellation_policy_accepted: medicareData?.cancellation_policy_accepted || false,
        medicare_number: medicareData?.medicare_number || '',
        medicare_irn: medicareData?.medicare_irn || '',
        date_of_birth: medicareData?.date_of_birth || '',
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const payload = {
                ...
                health_fund: formData.health_fund_name,
                is_veteran: !!(formData.veterans_affairs_number && formData.veterans_affairs_number.trim()),
